...
season_num NUMERIC,
episode_num NUMERIC,
CONSTRAINT pk_tv_episode PRIMARY KEY (tv_id, season_num,episode_num),
...
user_id NUMERIC,
movie_id NUMERIC,
CONSTRAINT pk_movie_watching PRIMARY KEY (user_id, movie_id),
...
user_id NUMERIC,
tv_id NUMERIC,
CONSTRAINT pk_tv_watching PRIMARY KEY (user_id, movie_id),
...
user_id NUMERIC,
movie_id NUMERIC,
CONSTRAINT pk_movie_liked PRIMARY KEY (user_id, movie_id),
...
user_id NUMERIC,
tv_id NUMERIC,
CONSTRAINT pk_tv_liked PRIMARY KEY (user_id, tv_id),
...
CREATE TABLE tv_series_completed (
    user_id NUMERIC,
    tv_id NUMERIC,
    user_rating NUMERIC,
    last_watched TIMESTAMP,
    CONSTRAINT pk_tv_series_completed PRIMARY KEY (user_id, tv_id),
    CONSTRAINT fk_tv_completed_user FOREIGN KEY (user_id) REFERENCES user_info(user_id),
    CONSTRAINT fk_tv_completed_tv FOREIGN KEY (tv_id) REFERENCES tv_series(tv_id)
);

CREATE TABLE movie_completed (
    user_id NUMERIC ,
    movie_id NUMERIC,
    user_rating NUMERIC,
    last_watched TIMESTAMP,
    CONSTRAINT fk_movie_completed_user FOREIGN KEY (user_id) REFERENCES user_info(user_id),
    CONSTRAINT fk_movie_completed_tv FOREIGN KEY (movie_id) REFERENCES movie(movie_id)
);
